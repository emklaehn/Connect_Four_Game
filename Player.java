...
public class Player {
    ...
    */
	...
	/* 
        ...
        *   by 2 and divide by 2 again (for the player average moves) to get 11. 
        *   Substract from number of moves, add 4 if person wins immediately. Multiply 
        *   by arbitrary large number (in this case 100) and add 600 so the lowest 
        *   score is 0.
        */
